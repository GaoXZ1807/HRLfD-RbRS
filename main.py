...
from hrlfd.train import run_hrlfd
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algo", default="hrlfd", type=str)
    parser.add_argument("--seed", default=2, type=int)
    parser.add_argument("--eval_freq", default=5e5, type=float)# before change eval_freq=5e3
    parser.add_argument("--max_timesteps", default=5e6, type=float) # bufore change max_timesteps = 5e6
    ...
    parser.add_argument("--traj_buffer_size", default=50000, type=int) # default = 50000
    ...
    parser.add_argument("--goal_loss_coeff", default=20., type=float) #goal_loss_coeff=20.
