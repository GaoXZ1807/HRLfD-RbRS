...
class EnvWithGoal(object):
    ...
    def __init__(self, base_env, env_name):
        ...
        self.goal = None
        #self.distance_threshold = 1 if env_name in ['AntMaze', 'AntPush', 'AntFall', 'AntMazeSparse'] else 1
        self.distance_threshold = 5 if env_name in ['AntMaze', 'AntPush', 'AntFall', 'AntMazeSparse'] else 1
        self.count = 0
    ...
    def reset(self):
        ...
        self.desired_goal = self.goal if self.env_name in ['AntMaze', 'AntPush', 'AntFall','AntMazeSparse'] else None
        return {
            'observation': obs.copy(),
            'achieved_goal': obs[:2],
