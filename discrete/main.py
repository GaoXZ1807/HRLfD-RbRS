...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, default='hrlfd')
    parser.add_argument('--env_name', type=str, default='Maze', help='Maze or KeyChest or AntMazeSparse')
    ...
    parser.add_argument('--goal_loss_coeff', type=float, default=0.0)# goal_loss_coeff=20
